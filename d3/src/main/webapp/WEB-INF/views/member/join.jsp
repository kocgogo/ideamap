				...
				$.ajax({
					...
					success:function(data){ 
						if(data.id=="1"){
							flag=0;
							$('.idcheckran').empty();
							$('.idcheckran').append('사용가능한 사원번호입니다.');
						}
						else{
							flag=1;					
							$('.idcheckran').empty();
							$('.idcheckran').append('이미 사용중인 사원번호입니다.');
						}
	...
	<form class="form-horizontal" action='joinImpl.do' method="POST">
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="control-group">
					<!-- E-mail -->
					<label class="control-label" for="id">사원번호</label>
					<div class="controls">
						...
						<p class="help-block">아이디를 입력해 주세요.</p><p class="idcheckran"></p>
					</div>
				</div>
			...
			<label class="control-label" for="M_affiliate">계열사</label>
			<div class="controls">
				<input type="text" id="M_affiliate" name="M_affiliate" placeholder=""
					class="input-xlarge" value="${userInfo.M_affiliate }">
				<p class="help-block">계열사를 입력해 주세요.</p>
			</div>
			...
			<div class="control-group">
				...
				<label class="control-label" for="M_division">부서</label>
				<div class="controls">
					<input type="text" id="M_division" name="M_division" placeholder=""
						class="input-xlarge" value="${userInfo.M_division }">
					<p class="help-block">부서를 입력해 주세요.</p>
					<input type="hidden" id="status" name="status" value="활동">
				</div>
			</div>
